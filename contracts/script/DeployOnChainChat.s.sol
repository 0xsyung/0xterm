...
import "../src/OnChainChat.sol";

/**
 * @title DeployOnChainChat
 * @dev Deploys OnChainChat with an initial message fee.
 *
 ...
 */
contract DeployOnChainChat is Script {
    // 0.0001 ETH in wei
    ...
    function run() external {
        ...
        OnChainChat chat = new OnChainChat(INITIAL_FEE);

        vm.stopBroadcast();

        console.log("OnChainChat deployed at:", address(chat));
