...
export type LogEntry = {
  id: string
  type: 'input' | 'text' | 'help' | 'dexes' | 'networks' | 'createpool' | 'initialize' | 'getpool' | 'addliq' | 'swap' | 'balance' | 'pool' | 'portfolio' | 'chat' | 'billboard' | 'share' | 'feed' | 'component' | 'dig-artifact' | 'dig-editor' | 'dig-abi' | 'dig-opcodes' | 'dig-run' | 'dig-confirm' | 'dig-ls' | 'dig-fn'
  text?: string
